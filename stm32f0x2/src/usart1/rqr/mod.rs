...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum ABRRQR {# [ doc = "resets the ABRF flag in the USART_ISR and request an automatic baud\nrate measurement on the next received data frame." ] SET , # [ doc = r" Reserved" ] _Reserved ( bool ) ,}
impl ABRRQR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
...
pub enum ABRRQW {# [ doc = "resets the ABRF flag in the USART_ISR and request an automatic baud\nrate measurement on the next received data frame." ] SET ,}
impl ABRRQW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
impl<'a> _ABRRQW<'a> {
    ...
    # [ doc = "resets the ABRF flag in the USART_ISR and request an automatic baud rate measurement on the next received data frame." ] # [ inline ]
    pub fn set(self) -> &'a mut W {
