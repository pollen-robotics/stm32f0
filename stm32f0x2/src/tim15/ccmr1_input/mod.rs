...
#[doc = "Possible values of the field `IC2PSC`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum IC2PSCR {
...
#[doc = "Values that can be written to the field `IC2PSC`"]
pub enum IC2PSCW {
    #[doc = "no prescaler, capture is done each time an edge is detected on the capture input"]
    NO,
    #[doc = "capture is done once every 2 events"]
...
impl<'a> _IC2PSCW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: IC2PSCW) -> &'a mut W {
        {
            self.bits(variant._bits())
        }
    }
    ...
    pub fn no(self) -> &'a mut W {
        self.variant(IC2PSCW::NO)
    }
    #[doc = "capture is done once every 2 events"]
    #[inline]
    pub fn _2events(self) -> &'a mut W {
        self.variant(IC2PSCW::_2EVENTS)
    }
    #[doc = "capture is done once every 4 events"]
    #[inline]
    pub fn _4events(self) -> &'a mut W {
        self.variant(IC2PSCW::_4EVENTS)
    }
    #[doc = "capture is done once every 8 events"]
    #[inline]
    pub fn _8events(self) -> &'a mut W {
        self.variant(IC2PSCW::_8EVENTS)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub fn bits(self, value: u8) -> &'a mut W {
