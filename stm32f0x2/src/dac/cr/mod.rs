...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TEN1R {
    #[doc = "DAC channel1 trigger disabled and data written into the DAC_DHRx register are\ntransferred one APB clock cycle later to the DAC_DOR1 register"] DISABLED,
    #[doc = "DAC channel1 trigger enabled and data from the DAC_DHRx register are transferred three APB clock cycles later to the DAC_DOR1 register"] ENABLED,
}
impl TEN1R {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline(always)]
...
impl<'a> _TEN1W<'a> {
    ...
    #[doc = "DAC channel1 trigger disabled and data written into the DAC_DHRx register are transferred one APB clock cycle later to the DAC_DOR1 register"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(TEN1W::DISABLED)
    }
    #[doc = "DAC channel1 trigger enabled and data from the DAC_DHRx register are transferred three APB clock cycles later to the DAC_DOR1 register"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
