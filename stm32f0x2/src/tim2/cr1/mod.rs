...
pub enum CMSW {# [ doc = "Edge-aligned mode. The counter counts up or down depending on the direction bit (DIR)." ] EDGEALIGN , # [ doc = "Center-aligned mode 1. The counter counts up and down alternatively. Output compare interrupt flags of channels configured in output (CCxS=00 in TIMx_CCMRx register) are set only when the counter is counting down." ] CENTERALIGNMODE1 , # [ doc = "Center-aligned mode 2. The counter counts up and down alternatively. Output compare interrupt flags of channels configured in output (CCxS=00 in TIMx_CCMRx register) are set only when the counter is counting up." ] CENTERALIGNMODE2 , # [ doc = "Center-aligned mode 3. The counter counts up and down alternatively. Output compare interrupt flags of channels configured in output (CCxS=00 in TIMx_CCMRx register) are set both when the counter is counting up or down." ] CENTERALIGNMODE3 ,}
impl CMSW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
impl<'a> _CMSW<'a> {
    ...
    # [ doc = "Center-aligned mode 1. The counter counts up and down alternatively. Output compare interrupt flags of channels configured in output (CCxS=00 in TIMx_CCMRx register) are set only when the counter is counting down." ] # [ inline ]
    pub fn center_align_mode1(self) -> &'a mut W {
        self.variant(CMSW::CENTERALIGNMODE1)
    }
    # [ doc = "Center-aligned mode 2. The counter counts up and down alternatively. Output compare interrupt flags of channels configured in output (CCxS=00 in TIMx_CCMRx register) are set only when the counter is counting up." ] # [ inline ]
    pub fn center_align_mode2(self) -> &'a mut W {
        self.variant(CMSW::CENTERALIGNMODE2)
    }
    # [ doc = "Center-aligned mode 3. The counter counts up and down alternatively. Output compare interrupt flags of channels configured in output (CCxS=00 in TIMx_CCMRx register) are set both when the counter is counting up or down." ] # [ inline ]
