...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum OC4PER {# [ doc = "Preload register on TIMx_CCR4 disabled. TIMx_CCR4 can be written at anytime, the new value is taken in account immediately" ] DISABLED , # [ doc = "Preload register on TIMx_CCR4 enabled. Read/Write operations access the preload register. TIMx_CCR4 preload value is loaded in the active register at each update event." ] ENABLED ,}
impl OC4PER {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum OC4FER {# [ doc = "CC4 behaves normally depending on counter and CCR4 values even when the trigger is ON. The minimum delay to activate CC4 output when an edge occurs on the trigger input is 5 clock cycles." ] DISABLED , # [ doc = "An active edge on the trigger input acts like a compare match on CC4 output. Then, OC is set to the compare level independently from the result of the comparison. Delay to sample the trigger input and to activate CC3 output is reduced to 3 clock cycles. OCFE acts only if the channel is configured in PWM1 or PWM2 mode." ] ENABLED ,}
impl OC4FER {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum OC3PER {# [ doc = "Preload register on TIMx_CCR3 disabled. TIMx_CCR3 can be written at anytime, the new value is taken in account immediately" ] DISABLED , # [ doc = "Preload register on TIMx_CCR3 enabled. Read/Write operations access the preload register. TIMx_CCR3 preload value is loaded in the active register at each update event." ] ENABLED ,}
impl OC3PER {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum OC3FER {# [ doc = "CC3 behaves normally depending on counter and CCR3 values even when the trigger is ON. The minimum delay to activate CC3 output when an edge occurs on the trigger input is 5 clock cycles." ] DISABLED , # [ doc = "An active edge on the trigger input acts like a compare match on CC3 output. Then, OC is set to the compare level independently from the result of the comparison. Delay to sample the trigger input and to activate CC3 output is reduced to 3 clock cycles. OCFE acts only if the channel is configured in PWM1 or PWM2 mode." ] ENABLED ,}
impl OC3FER {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
...
pub enum OC4PEW {# [ doc = "Preload register on TIMx_CCR4 disabled. TIMx_CCR4 can be written at anytime, the new value is taken in account immediately" ] DISABLED , # [ doc = "Preload register on TIMx_CCR4 enabled. Read/Write operations access the preload register. TIMx_CCR4 preload value is loaded in the active register at each update event." ] ENABLED ,}
impl OC4PEW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
impl<'a> _OC4PEW<'a> {
    ...
    # [ doc = "Preload register on TIMx_CCR4 disabled. TIMx_CCR4 can be written at anytime, the new value is taken in account immediately" ] # [ inline ]
    pub fn disabled(self) -> &'a mut W {
        self.variant(OC4PEW::DISABLED)
    }
    # [ doc = "Preload register on TIMx_CCR4 enabled. Read/Write operations access the preload register. TIMx_CCR4 preload value is loaded in the active register at each update event." ] # [ inline ]
    pub fn enabled(self) -> &'a mut W {
...
pub enum OC4FEW {# [ doc = "CC4 behaves normally depending on counter and CCR4 values even when the trigger is ON. The minimum delay to activate CC4 output when an edge occurs on the trigger input is 5 clock cycles." ] DISABLED , # [ doc = "An active edge on the trigger input acts like a compare match on CC4 output. Then, OC is set to the compare level independently from the result of the comparison. Delay to sample the trigger input and to activate CC3 output is reduced to 3 clock cycles. OCFE acts only if the channel is configured in PWM1 or PWM2 mode." ] ENABLED ,}
impl OC4FEW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
impl<'a> _OC4FEW<'a> {
    ...
    # [ doc = "CC4 behaves normally depending on counter and CCR4 values even when the trigger is ON. The minimum delay to activate CC4 output when an edge occurs on the trigger input is 5 clock cycles." ] # [ inline ]
    pub fn disabled(self) -> &'a mut W {
        self.variant(OC4FEW::DISABLED)
    }
    # [ doc = "An active edge on the trigger input acts like a compare match on CC4 output. Then, OC is set to the compare level independently from the result of the comparison. Delay to sample the trigger input and to activate CC3 output is reduced to 3 clock cycles. OCFE acts only if the channel is configured in PWM1 or PWM2 mode." ] # [ inline ]
    pub fn enabled(self) -> &'a mut W {
...
impl<'a> _OC3PEW<'a> {
    ...
    # [ doc = "Preload register on TIMx_CCR3 disabled. TIMx_CCR3 can be written at anytime, the new value is taken in account immediately" ] # [ inline ]
    pub fn disabled(self) -> &'a mut W {
        self.variant(OC3PEW::DISABLED)
    }
    # [ doc = "Preload register on TIMx_CCR3 enabled. Read/Write operations access the preload register. TIMx_CCR3 preload value is loaded in the active register at each update event." ] # [ inline ]
    pub fn enabled(self) -> &'a mut W {
...
pub enum OC3FEW {# [ doc = "CC3 behaves normally depending on counter and CCR3 values even when the trigger is ON. The minimum delay to activate CC3 output when an edge occurs on the trigger input is 5 clock cycles." ] DISABLED , # [ doc = "An active edge on the trigger input acts like a compare match on CC3 output. Then, OC is set to the compare level independently from the result of the comparison. Delay to sample the trigger input and to activate CC3 output is reduced to 3 clock cycles. OCFE acts only if the channel is configured in PWM1 or PWM2 mode." ] ENABLED ,}
impl OC3FEW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
impl<'a> _OC3FEW<'a> {
    ...
    # [ doc = "CC3 behaves normally depending on counter and CCR3 values even when the trigger is ON. The minimum delay to activate CC3 output when an edge occurs on the trigger input is 5 clock cycles." ] # [ inline ]
    pub fn disabled(self) -> &'a mut W {
        self.variant(OC3FEW::DISABLED)
    }
    # [ doc = "An active edge on the trigger input acts like a compare match on CC3 output. Then, OC is set to the compare level independently from the result of the comparison. Delay to sample the trigger input and to activate CC3 output is reduced to 3 clock cycles. OCFE acts only if the channel is configured in PWM1 or PWM2 mode." ] # [ inline ]
    pub fn enabled(self) -> &'a mut W {
