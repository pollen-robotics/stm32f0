...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SSOER {# [ doc = "SS output is disabled in master mode and the SPI interface can work in multimaster\nconfiguration" ] DISABLED , # [ doc = "SS output is enabled in master mode and when the SPI interface is enabled. The SPI\ninterface cannot work in a multimaster environment" ] ENABLED ,}
impl SSOER {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RXNEIER {# [ doc = "RXNE interrupt masked" ] DISABLED , # [ doc = "RXNE interrupt not masked. Used to generate an interrupt request when the RXNE flag is set." ] ENABLED ,}
impl RXNEIER {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TXEIER {# [ doc = "TXE interrupt masked" ] DISABLED , # [ doc = "TXE interrupt not masked. Used to generate an interrupt request when the TXE flag is set." ] ENABLED ,}
impl TXEIER {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
...
pub enum SSOEW {# [ doc = "SS output is disabled in master mode and the SPI interface can work in multimaster\nconfiguration" ] DISABLED , # [ doc = "SS output is enabled in master mode and when the SPI interface is enabled. The SPI\ninterface cannot work in a multimaster environment" ] ENABLED ,}
impl SSOEW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
impl<'a> _SSOEW<'a> {
    ...
    # [ doc = "SS output is disabled in master mode and the SPI interface can work in multimaster configuration" ] # [ inline ]
    pub fn disabled(self) -> &'a mut W {
        self.variant(SSOEW::DISABLED)
    }
    # [ doc = "SS output is enabled in master mode and when the SPI interface is enabled. The SPI interface cannot work in a multimaster environment" ] # [ inline ]
    pub fn enabled(self) -> &'a mut W {
...
pub enum RXNEIEW {# [ doc = "RXNE interrupt masked" ] DISABLED , # [ doc = "RXNE interrupt not masked. Used to generate an interrupt request when the RXNE flag is set." ] ENABLED ,}
impl RXNEIEW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
impl<'a> _RXNEIEW<'a> {
    ...
    # [ doc = "RXNE interrupt not masked. Used to generate an interrupt request when the RXNE flag is set." ] # [ inline ]
    pub fn enabled(self) -> &'a mut W {
...
pub enum TXEIEW {# [ doc = "TXE interrupt masked" ] DISABLED , # [ doc = "TXE interrupt not masked. Used to generate an interrupt request when the TXE flag is set." ] ENABLED ,}
impl TXEIEW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
...
impl<'a> _TXEIEW<'a> {
    ...
    # [ doc = "TXE interrupt not masked. Used to generate an interrupt request when the TXE flag is set." ] # [ inline ]
    pub fn enabled(self) -> &'a mut W {
