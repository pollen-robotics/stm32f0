...
pub fn init(baudrate: u32, nbits : NBits , nbstopbits : StopBits, parity : Parity){
    cortex_m::interrupt::free(|cs|{
        ...
        gpioa.ospeedr.write(|w|w.ospeedr9().high_speed()
            .ospeedr10().high_speed());
        gpioa.pupdr.write(|w| w.pupdr9().pull_up()
            .pupdr10().pull_up());
        gpioa.afrh.write(|w|w.afrh9().af1()
            .afrh10().af1());
        gpioa.moder.write(|w|w.moder9().alternate()
            .moder10().alternate());
        gpioa.otyper.write(|w| w.ot9().push_pull()
            .ot10().push_pull());
        ...
        uart1.cr1.modify(|_,w| w.te().enabled()
            .re().enabled()
            .over8().over8()
            .rxneie().enabled());
        ...
        uart1.cr3.write(|w| w.rtse().disabled()
            .ctse().disabled()
            .ctsie().disabled()
            .ovrdis().disabled());
